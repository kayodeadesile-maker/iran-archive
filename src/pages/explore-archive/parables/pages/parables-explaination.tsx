...
export default function ParablesbDetailExplaination() {
      ...
      <div className="max-w-6xl mx-auto">
        ...
        <article className="">
          ...
          <div className="border-t border-gray-400 py-2">
            ...
            <div className="flex flex-col sm:items-center sm:flex-row sm:justify-between xl:gap-0 mt-5">
              ...
              <div className="inline-flex items-center gap-3">
                <p className="font-satoshi font-medium text-lg shrink-0">Share on:</p>
          ...
          <SuggestionComponent
            ...
            title="Popular Parable and Wise Saying"
